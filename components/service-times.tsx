...
import FadeInSection from "@/components/FadeInSection" // adjust the path if needed

export default function ServiceTimes() {
  return (
    <section id="services" className="scroll-mt-24 py-12 bg-gradient-to-b from-blue-100 via-white to-red-100">
      <FadeInSection>
